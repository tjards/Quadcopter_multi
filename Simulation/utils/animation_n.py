...
#def sameAxisAnimationN(config, myData, traj, params, myData2, traj2, params2, obsPF, myColour = 'blue', myColour2 = 'green'):
def sameAxisAnimationN(config, myData, traj, quadList, obsPF, myColour = 'blue'):
    ...
    line_ani = animation.FuncAnimation(fig, updateLines, blit=False, frames=len(t_all[0][0:-2:numFrames]), interval=(Ts*1000*numFrames))
    ...
    if (ifsave):
        ...
        line_ani.save('Gifs/Raw/animation_multi_{0}_and_{1}.gif'.format(myColour,myColour), writer=writer) #my add
